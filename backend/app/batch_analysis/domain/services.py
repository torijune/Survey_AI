...
# from app.batch_analysis.application.workflow import TableAnalysisWorkflow  # 순환참조 방지 위해 제거


class BatchAnalysisService:
    """배치 분석 비즈니스 로직 서비스"""
    
    def __init__(self, repository: BatchAnalysisRepository, workflow):  # 타입 힌트 제거
